	...
	_rel_pot5(a, _REL)//,
{
	...
	_envelope.delay(0);
	_envelope.hold(0);
	inputSocket.push_back(new InputSocket(a, GATE, GATE_D, _gate, 0, "ADSR_GATE"));
	
	outputSocket.push_back(new OutputSocket(a, SIGNAL_OUT, SIGNAL_OUT_D, _envelope, 0, "ADSR_OUT"));
